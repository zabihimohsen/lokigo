...
> **Pre-1.0 notice:** `lokigo` is actively used and tested, but still pre-1.0. Minor API changes may happen as the project evolves.
...
- **Versioning:** pre-1.0 semver (`0.x`), with occasional breaking changes when needed.
